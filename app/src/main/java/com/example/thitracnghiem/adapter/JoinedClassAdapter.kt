...
class JoinedClassAdapter(private val classList: List<ClassItem>, private val listener: OnItemClickListener) : RecyclerView.Adapter<JoinedClassAdapter.ClassViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ClassViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_classroom2, parent, false)
